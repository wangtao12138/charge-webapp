...
public class ChargerSchemeController {
    ...
    @ApiImplicitParam(name = "projectParam", value = "站点", required = true)
    ...
    @ApiImplicitParam(name = "projectSchemeQuery", value = "查询条件", required = true)
    @GetMapping(value = "/schemes/profitable")
    public ApiResult countProfitable(@ModelAttribute ProjectSchemeQuery queryVo){
        ApiResult result=new ApiResult();
        //调用业务层
